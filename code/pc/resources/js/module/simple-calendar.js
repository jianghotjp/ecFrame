...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function create() {
      ...
      //actions
      header.innerHTML = header.innerHTML + '<div class="sc-actions sc-actions-time"><span class="sc-return-today ">今天</span></div>';

      // header.innerHTML = header.innerHTML + '<div class="sc-actions">' +  ;
      header.innerHTML = header.innerHTML + '<div class="sc-actions sc-actions-year">' + '    <div class="sc-mleft">' + '      &lsaquo;</div>' +'<div class="sc_nowym"></div>' + '      <select class="sc-select-year" name="">' + '      </select>' + '    <select class="sc-select-month" name="">' + '    </select>' + '    <div class="sc-mright">&rsaquo;</div>' + '</div>';
    ...
    value: function updateSelect(year, month) {
      ...
      var nowym  =  this.container.querySelector('.sc_nowym');
      ...
      nowym.innerHTML = selectYear.value+'-'+month;
    ...
    value: function updateEvent() {
      ...
      var nowym  =  container.querySelector('.sc_nowym');
      ...
      monthadd.onclick = function () {
        ...
        nowym.innerHTML = selectYear.value+'-'+currentmonth;
      };
